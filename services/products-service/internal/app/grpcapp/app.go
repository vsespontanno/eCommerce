...
import (
	...
	"github.com/vsespontanno/eCommerce/services/products-service/internal/presentation/grpc/products"
...
func NewApp(log *zap.SugaredLogger, productsInterface products.Products, sagaReserver saga.Reserver, productsPort, sagaPort int) *App {
	...
	proto.RegisterSagaProductsServer(sagaServer, saga.NewSagaServer(sagaReserver, log))
