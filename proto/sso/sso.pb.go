...
type ValidateTokenResponse struct {
	...
	UserId        int64                  `protobuf:"varint,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"` // UUID of the user
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_sso_sso_proto_rawDesc = "" +
	"\n" +
	"\x13proto/sso/sso.proto\x12\tproto_sso\"\x7f\n" +
	...
	"\auser_id\x18\x02 \x01(\x03R\x06userId2\x87\x01\n" +
	"\x04Auth\x12C\n" +
	"\bRegister\x12\x1a.proto_sso.RegisterRequest\x1a\x1b.proto_sso.RegisterResponse\x12:\n" +
	"\x05Login\x12\x17.proto_sso.LoginRequest\x1a\x18.proto_sso.LoginResponse2_\n" +
	"\tValidator\x12R\n" +
	"\rValidateToken\x12\x1f.proto_sso.ValidateTokenRequest\x1a .proto_sso.ValidateTokenResponseB6Z4github.com/vsespontanno/eCommerce/internal/proto/ssob\x06proto3"
