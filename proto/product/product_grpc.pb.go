// Code generated by protoc-gen-go-user. DO NOT EDIT.
// versions:
// - protoc-gen-go-user v1.5.1
// - protoc             v3.21.12
...
// is compatible with the user package it is being compiled against.
...
// It's only intended for direct use with user.RegisterService,
